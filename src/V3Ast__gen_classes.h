...
class AstNode;
class AstAcosD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstAcoshD;           // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstAsinD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstAsinhD;           // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstAtan2D;           // AstNode         AstNodeMath     AstNodeBiop     AstNodeSystemBiop 
class AstAtanD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstAtanhD;           // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstCeilD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstCosD;             // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstCoshD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstExpD;             // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstFloorD;           // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstHypotD;           // AstNode         AstNodeMath     AstNodeBiop     AstNodeSystemBiop 
...
class AstLog10D;           // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstLogAnd;           // AstNode         AstNodeMath     AstNodeBiop     
class AstLogD;             // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstNodePslCoverOrAssert; // AstNode         AstNodeStmt     
...
class AstNodeSystemBiop;   // AstNode         AstNodeMath     AstNodeBiop     
class AstNodeSystemUniop;  // AstNode         AstNodeMath     AstNodeUniop    
...
class AstPslAssert;        // AstNode         AstNodeStmt     AstNodePslCoverOrAssert 
class AstPslClocked;       // AstNode         
class AstPslCover;         // AstNode         AstNodeStmt     AstNodePslCoverOrAssert 
...
class AstSinD;             // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstSinhD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstSliceSel;         // AstNode         AstNodeMath     AstNodeTriop    
class AstSqrtD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
...
class AstTanD;             // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
class AstTanhD;            // AstNode         AstNodeMath     AstNodeUniop    AstNodeSystemUniop 
